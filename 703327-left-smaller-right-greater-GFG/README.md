# [Left Smaller Right Greater](https://www.geeksforgeeks.org/problems/unsorted-array4925/1)
## Easy
...
Input: arr = [11, 9, 12]
Output: -1Explanation: No element in the array satisfies the required condition.
Constraints:3&nbsp;≤&nbsp;arr.size()&nbsp;≤&nbsp;1061&nbsp;≤ arr[i] ≤&nbsp;106