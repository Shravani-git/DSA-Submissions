# [Non-Repeating Element](https://www.geeksforgeeks.org/problems/non-repeating-element3958/1?page=1&category=Arrays&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Easy
...
Input: arr[] = [1, 1, 1]
Output: 0Explanation: There is not present any non-repeating element so answer should be 0.
Constraints:1 &lt;= arr.size &lt;= 106-109 &lt;= arr[i]&nbsp;&lt;= 109arr[i] != 0&nbsp;