# [Find triplets with zero sum](https://www.geeksforgeeks.org/problems/find-triplets-with-zero-sum/1?page=3&category=Arrays,Linked%20List&sortBy=submissions)
## Medium
