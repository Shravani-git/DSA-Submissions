# [Pair With Difference](https://www.geeksforgeeks.org/problems/find-pair-given-difference1559/1?page=7&sortBy=submissions)
## Easy
...
Input: arr[] = [1], x = 1
Output: false
Constraints:1&lt;= arr.size() &lt;=106&nbsp;1&lt;= arr[i] &lt;=106&nbsp;0&lt;= x &lt;=105