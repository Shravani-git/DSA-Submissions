# [Delete Middle of Linked List](https://www.geeksforgeeks.org/problems/delete-middle-of-linked-list/1?page=1&category=Arrays,Linked%20List,prefix-sum&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Easy
