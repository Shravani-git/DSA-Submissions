# [Twice Counter](https://www.geeksforgeeks.org/problems/twice-counter4236/1?page=1&category=Java,Map,set&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Easy
